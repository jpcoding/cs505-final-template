...
def getperson(zip_map, count, patient_mrn):
    ...
    patientRecord["contact_list"] = random.choices(
        contact_master, k=random.randint(1, count/2))
    patientRecord["event_list"] = random.choices(
        event_master, k=random.randint(1, count / 2))
